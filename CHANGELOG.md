...
## Version [0.12.0](https://git.belin.io/cedx/phpunit-expect/compare/v0.11.0...v0.12.0)
- Updated the documentation.
- Updated the package dependencies.

## Version [0.11.0](https://git.belin.io/cedx/phpunit-expect/compare/v0.10.0...v0.11.0)
- Added an example code.
- Updated the package dependencies.

## Version [0.10.0](https://git.belin.io/cedx/phpunit-expect/compare/v0.9.0...v0.10.0)
- Upgraded [PHPUnit](https://phpunit.de) to version 9.

## Version [0.9.0](https://git.belin.io/cedx/phpunit-expect/compare/v0.8.0...v0.9.0)
- Breaking change: raised the required [PHP](https://www.php.net) version.
- Breaking change: using PHP 7.4 features, like arrow functions and typed properties.

## Version [0.8.0](https://git.belin.io/cedx/phpunit-expect/compare/v0.7.0...v0.8.0)
- The `skip()` function can mark the surrounding test as skipped.
- Updated the package dependencies.

## Version [0.7.0](https://git.belin.io/cedx/phpunit-expect/compare/v0.6.0...v0.7.0)
...
## Version [0.6.0](https://git.belin.io/cedx/phpunit-expect/compare/v0.5.0...v0.6.0)
- Added support for [PHPStan](https://github.com/phpstan/phpstan) static analyzer.
- Updated the package dependencies.

## Version [0.5.0](https://git.belin.io/cedx/phpunit-expect/compare/v0.4.0...v0.5.0)
- Breaking change: raised the required [PHP](https://www.php.net) version.
...
## Version [0.4.0](https://git.belin.io/cedx/phpunit-expect/compare/v0.3.0...v0.4.0)
...
## Version [0.3.0](https://git.belin.io/cedx/phpunit-expect/compare/v0.2.0...v0.3.0)
...
## Version [0.2.0](https://git.belin.io/cedx/phpunit-expect/compare/v0.1.0...v0.2.0)
